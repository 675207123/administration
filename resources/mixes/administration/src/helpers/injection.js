...
function install(Vue) {
    ...
    if (token && token.access_token) {
        ...
        //                         window.console
        // .log(`插件[${informations[index].identification}]加载成功！`);
        //                     } else {
        //                         window.console
        // .warn(`插件[${informations[index].identification}]加载失败！`);
        //                     }
        //                     break;
        //                 case 'module':
        //                     if (data[index] && data[index].default) {
        ...
        //                         window.console
        // .log(`模块[${informations[index].identification}]加载成功！`);
        //                     } else {
        //                         window.console
        // .warn(`模块[${informations[index].identification}]加载失败！`);
        //                     }
        //                     break;
        //                 default:
